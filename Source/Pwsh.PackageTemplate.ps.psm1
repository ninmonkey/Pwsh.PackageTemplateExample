...
if ($__buildCfg.LoadTypeAndFormatdata) {
    Update-FormatData -PrependPath (Join-Path $PSScriptRoot 'Pwsh.PackageTemplate.format.ps1xml' )
    Update-TypeData -PrependPath (Join-Path $PSScriptRoot 'Pwsh.PackageTemplate.types.ps1xml' ) -ErrorAction Ignore
}
# }
